...
// Tensorflow provides support to perform I/O operations as well.
// Normally you should be able to perform these types of operations
// using the library/framework of your choice. I believe reason
// tensorflow provides the support is to provide an abstraction layer
// for various platforms it supports.
//
// In this example we are going to look at few I/O related apis.
//
// Run this example as:
...
int main(int argc, char** argv)
{
  ...
  // In order to read the content of the file we first get a file handle.
  ...
  // Create StringPiece which is nothing but a view of any external data location.
  //
